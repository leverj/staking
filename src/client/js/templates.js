...
$.fn.userInfo = function () {
  this.append(
    ...
    "<h4 class='user-info-row'><a href='javascript:void(0);'><span name='timestamp'></span> <i class='fa fa-clock-o'></i></a><label>Timestamp</label></h4>"
  );
};
...
$.fn.txInfo = function (prefix) {
  this.append(
    ...
    "<h4 class='user-info-row'><a href='javascript:void(0);'><span id='" + prefix + "-timestamp'></span> <i class='fa fa-clock-o'></i></a><label>Timestamp</label></h4>"
  );
};
